...
<body>
  <div class="calculator">
    <div class="calculator-header">Calculator</div>
    <div class="display">
      <input type="text" id="expression" placeholder="0" autocomplete="off">
      <div id="result"></div>
    </div>
    <div class="keypad">
  ...
  <script>
    ...
    function memoryPlus() {
      if (display.value) memory += parseFloat(display.value) || 0;
    }
